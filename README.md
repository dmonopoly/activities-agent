...
- ⚙️ **Preferences Management**: Set location, interests, budget, and other preferences
...
- `GOOGLE_MAPS_API_KEY`: Google Maps API key for Places API integration. Get one at [Google Cloud Console](https://console.cloud.google.com/). Enable Places API and Geocoding API.
- `OPENWEATHER_API_KEY`: OpenWeatherMap API key for weather information. Get one at [OpenWeatherMap](https://openweathermap.org/api). Free tier: 60 calls/minute.
